...
- [ 🟡 [2] ] El contrato desplegado en testnet es **funcional** y permite interactuar con todas las funcionalidades requeridas.

---

## 3. Testing y calidad del código

- [ 🟢 [3] ] Existe una suite de tests automatizados que cubre **≥ 85%** del código del contrato.
- [ 🟢 [4] ] El código está bien estructurado y comentado según lo visto en clase.
- [ 🟡 [5] ] Incluye documentación técnica clara para las funcionalidades implementadas.
...
### Publicación de productos
- [ 🟢 [6] ] Como `Vendedor`, publicar al menos un producto con todos los datos requeridos.
...
- [ 🟢 [7] ] Chequear que se descuente correctamente el stock tras la compra.
- [ 🟡 [8] ] Verificar que la orden queda en estado `pendiente`.
...
### General
- [ 🟢 [9] ] Confirmar que los cambios de estado y acciones se reflejan correctamente en el almacenamiento y pueden ser consultados vía RPC.
